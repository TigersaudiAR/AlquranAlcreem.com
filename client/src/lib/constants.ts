...
export const SURAH_NAMES = [
  ...
  { number: 3, name: "آل عمران", englishName: "Aal-Imraan" },
  { number: 4, name: "النساء", englishName: "An-Nisaa" },
  { number: 5, name: "المائدة", englishName: "Al-Maaida" },
  { number: 6, name: "الأنعام", englishName: "Al-An'aam" },
  { number: 7, name: "الأعراف", englishName: "Al-A'raaf" },
  { number: 8, name: "الأنفال", englishName: "Al-Anfaal" },
  { number: 9, name: "التوبة", englishName: "At-Tawba" },
  ...
  { number: 17, name: "الإسراء", englishName: "Al-Israa" },
  { number: 18, name: "الكهف", englishName: "Al-Kahf" },
  { number: 19, name: "مريم", englishName: "Maryam" },
  { number: 20, name: "طه", englishName: "Taa-Haa" },
